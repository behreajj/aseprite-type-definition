...
Dialog = {
    ...
    ---@param dialog Dialog
    ---@param options {id: string, color: Color, colors: Color[], enabled: boolean, filename: string, max: integer, min: integer, mousecursor: MouseCursor, option: string, selected: boolean, text: string, value: integer, visible: boolean}
    ---@return Dialog
